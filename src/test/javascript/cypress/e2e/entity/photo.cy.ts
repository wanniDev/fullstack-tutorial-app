...
describe('Photo e2e test', () => {
  ...
  describe('new Photo page', () => {
    ...
    it('should create an instance of Photo', () => {
      ...
      cy.get(`[data-cy="height"]`).type('52415').should('have.value', '52415');

      cy.get(`[data-cy="width"]`).type('68453').should('have.value', '68453');

      cy.get(`[data-cy="taken"]`).type('2022-10-08T07:53').blur().should('have.value', '2022-10-08T07:53');

      cy.get(`[data-cy="uploaded"]`).type('2022-10-07T14:09').blur().should('have.value', '2022-10-07T14:09');
